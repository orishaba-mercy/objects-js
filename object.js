...
function humans(){
  let adults=people.filter(person=>person.age>=18)
   ...
   let nameOlder=adults.map(person=>person.name);
return nameOlder
...
// ];
 function object() { 
const result=products.reduce((group,array)=>{
...
// // a student with a name and an array of scores, write a function 
// // that returns a new array containing the names of all students whose
...
// // write a function that takes the car object and adds a new method to the object
// //  called age. The age method should return the 
// // current age of the car based on the current year 
